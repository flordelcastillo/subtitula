...
window.I18N = (() => {
  const T = {
    es: {
      ...
      "listen": "Escuchar", "listening": "Escuchando", "listen.title": "Escuchar la interpretación con auriculares",
      ...
      "jump": "Volver al vivo", "size.smaller": "Achicar el texto", "size.bigger": "Agrandar el texto", "more": "Más",
      ...
      "demo.recorded": "Grabado el {date} con", "demo.lat": "Demora p50: original {o}, traducción {t}", "demo.errors": "{n} errores",
    ...
    en: {
      ...
      "listen": "Listen", "listening": "Listening", "listen.title": "Listen to the interpretation with headphones",
      ...
      "demo.recorded": "Recorded on {date} with", "demo.lat": "p50 delay: original {o}, translation {t}", "demo.errors": "{n} errors",
      "demo.original": "(original)",
    },
    pt: {
      ...
      "listen": "Ouvir", "listening": "Ouvindo", "listen.title": "Ouvir a interpretação com fones",
      ...
      "jump": "Voltar ao vivo", "size.smaller": "Diminuir o texto", "size.bigger": "Aumentar o texto", "more": "Mais",
      ...
      "demo.recorded": "Gravado em {date} com", "demo.lat": "Atraso p50: original {o}, tradução {t}", "demo.errors": "{n} erros",
      "demo.original": "(original)",
    },
  };
